...
// SetOwerID sets the "ower" edge to the User entity by ID.
func (cu *CarUpdate) SetOwerID(id int) *CarUpdate {
	cu.mutation.SetOwerID(id)
	return cu
}

// SetNillableOwerID sets the "ower" edge to the User entity by ID if the given value is not nil.
func (cu *CarUpdate) SetNillableOwerID(id *int) *CarUpdate {
	if id != nil {
		cu = cu.SetOwerID(*id)
	}
	return cu
...
// SetOwer sets the "ower" edge to the User entity.
func (cu *CarUpdate) SetOwer(u *User) *CarUpdate {
	return cu.SetOwerID(u.ID)
}
...
// ClearOwer clears the "ower" edge to the User entity.
func (cu *CarUpdate) ClearOwer() *CarUpdate {
	cu.mutation.ClearOwer()
	return cu
}
...
func (cu *CarUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if cu.mutation.OwerCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   car.OwerTable,
			Columns: []string{car.OwerColumn},
			Bidi:    false,
	...
	if nodes := cu.mutation.OwerIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   car.OwerTable,
...
// SetOwerID sets the "ower" edge to the User entity by ID.
func (cuo *CarUpdateOne) SetOwerID(id int) *CarUpdateOne {
	cuo.mutation.SetOwerID(id)
	return cuo
}

// SetNillableOwerID sets the "ower" edge to the User entity by ID if the given value is not nil.
func (cuo *CarUpdateOne) SetNillableOwerID(id *int) *CarUpdateOne {
	if id != nil {
		cuo = cuo.SetOwerID(*id)
	}
	return cuo
}

// SetOwer sets the "ower" edge to the User entity.
func (cuo *CarUpdateOne) SetOwer(u *User) *CarUpdateOne {
	return cuo.SetOwerID(u.ID)
}
...
// ClearOwer clears the "ower" edge to the User entity.
func (cuo *CarUpdateOne) ClearOwer() *CarUpdateOne {
	cuo.mutation.ClearOwer()
	return cuo
}
...
func (cuo *CarUpdateOne) sqlSave(ctx context.Context) (_node *Car, err error) {
	...
	if nodes := cuo.mutation.OwerIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   car.OwerTable,

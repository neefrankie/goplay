...
func (cc *CarCreate) SetOwerID(id int) *CarCreate {
	cc.mutation.SetOwerID(id)
	return cc
}

// SetNillableOwerID sets the "ower" edge to the User entity by ID if the given value is not nil.
func (cc *CarCreate) SetNillableOwerID(id *int) *CarCreate {
	if id != nil {
		cc = cc.SetOwerID(*id)
	}
	return cc
...
func (cc *CarCreate) SetOwer(u *User) *CarCreate {
	return cc.SetOwerID(u.ID)
}
...
func (cc *CarCreate) createSpec() (*Car, *sqlgraph.CreateSpec) {
	...
	if nodes := cc.mutation.OwerIDs(); len(nodes) > 0 {

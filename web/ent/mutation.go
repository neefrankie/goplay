...
func (m *CarMutation) SetOwerID(id int) {
	m.ower = &id
}

// ClearOwer clears the "ower" edge to the User entity.
func (m *CarMutation) ClearOwer() {
	m.clearedower = true
}

// OwerCleared reports if the "ower" edge to the User entity was cleared.
func (m *CarMutation) OwerCleared() bool {
	return m.clearedower
}

// OwerID returns the "ower" edge ID in the mutation.
func (m *CarMutation) OwerID() (id int, exists bool) {
	if m.ower != nil {
		return *m.ower, true
	}
	return
...
// OwerIDs returns the "ower" edge IDs in the mutation.
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// OwerID instead. It exists only for internal usage by the builders.
func (m *CarMutation) OwerIDs() (ids []int) {
	if id := m.ower; id != nil {
		ids = append(ids, *id)
	}
	return
...
// ResetOwer resets all changes to the "ower" edge.
func (m *CarMutation) ResetOwer() {
	m.ower = nil
	m.clearedower = false
}
...
func (m *CarMutation) AddedEdges() []string {
	...
	if m.ower != nil {
		edges = append(edges, car.EdgeOwer)
	}
	return edges
}

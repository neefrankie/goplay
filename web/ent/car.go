...
type CarEdges struct {
	// Ower holds the value of the ower edge.
	Ower *User `json:"ower,omitempty"`
	// loadedTypes holds the information for reporting if a
	// type was loaded (or requested) in eager-loading or not.
	loadedTypes [1]bool
}

// OwerOrErr returns the Ower value or an error if the edge
// was not loaded in eager-loading, or loaded but was not found.
func (e CarEdges) OwerOrErr() (*User, error) {
	if e.loadedTypes[0] {
		if e.Ower == nil {
	...
	return nil, &NotLoadedError{edge: "ower"}
}
...
// QueryOwer queries the "ower" edge of the Car entity.
func (c *Car) QueryOwer() *UserQuery {
	return NewCarClient(c.config).QueryOwer(c)
}

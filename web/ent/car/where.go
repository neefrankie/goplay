...
// HasOwer applies the HasEdge predicate on the "ower" edge.
func HasOwer() predicate.Car {
...
// HasOwerWith applies the HasEdge predicate on the "ower" edge with a given conditions (other predicates).
func HasOwerWith(preds ...predicate.User) predicate.Car {
	return predicate.Car(func(s *sql.Selector) {
		step := newOwerStep()
